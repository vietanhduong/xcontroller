...
var barsResource = schema.GroupVersionResource{Group: "foo.anhdv.dev", Version: "v1alpha1", Resource: "bars"}

var barsKind = schema.GroupVersionKind{Group: "foo.anhdv.dev", Version: "v1alpha1", Kind: "Bar"}
...
func (c *FakeBars) UpdateStatus(ctx context.Context, bar *v1alpha1.Bar, opts v1.UpdateOptions) (*v1alpha1.Bar, error) {
	obj, err := c.Fake.
