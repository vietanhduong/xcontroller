...
import (
	...
	scheme "github.com/vietanhduong/xcontroller/pkg/client/clientset/versioned/scheme"
...
func (c *bars) UpdateStatus(ctx context.Context, bar *v1alpha1.Bar, opts v1.UpdateOptions) (result *v1alpha1.Bar, err error) {
	result = &v1alpha1.Bar{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bars").
