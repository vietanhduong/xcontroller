...
import (
	...
	foov1alpha1 "github.com/vietanhduong/xcontroller/pkg/apis/foo/v1alpha1"
	versioned "github.com/vietanhduong/xcontroller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/vietanhduong/xcontroller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/vietanhduong/xcontroller/pkg/client/listers/foo/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FooV1alpha1().Bars(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FooV1alpha1().Bars(namespace).Watch(context.TODO(), options)
			},
		},
		&foov1alpha1.Bar{},
		resyncPeriod,
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foov1alpha1.Bar{}, f.defaultInformer)
}
